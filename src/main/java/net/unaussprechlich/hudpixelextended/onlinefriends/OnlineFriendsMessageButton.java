...
import static net.unaussprechlich.hudpixelextended.util.ImageLoader.chatLocation;
...
public class OnlineFriendsMessageButton extends FancyListButton {
    ...
    protected void onClick() {
        FMLClientHandler.instance().getClientPlayerEntity().sendChatMessage("/msg " + playerName);
    }
}
