...
public class BlitzStarTracker implements IComponent {
    ...
    private final long DURATION = 31000; // = 30s
    private long startTime;
    private long timeLeft; // in seconds, only for rendering
    ...
    public void onTickUpdate() {
        ...
        if(this.currentPhase == Phase.ACTIVE) {
            ...
            this.timeLeft = (DURATION - (System.currentTimeMillis() - startTime)) / 1000;
        ...
        // the holder was killed
            ...
            if (textMessage.contains(" by ")) {
                ...
                if(messageStartingWithKiller.contains(" ")) {
                    this.owner = messageStartingWithKiller.substring(0, messageStartingWithKiller.indexOf(' ')).replace("!", "");
                } else  {
                    this.owner = messageStartingWithKiller.replace("!", "");
                }
            } else {
                this.owner = "Unknown";
            }
    ...
    public String getRenderingString() {
        ...
        case FOUND:
            ...
            return DISPLAY_MESSAGE + EnumChatFormatting.LIGHT_PURPLE + this.owner;
        case ACTIVE:
            return DISPLAY_MESSAGE + EnumChatFormatting.RED + this.owner + " -> " + this.activatedBlitz + "(" + this.timeLeft + "s)";
        case FORFEIT:
        case USED:
            // it's gone
