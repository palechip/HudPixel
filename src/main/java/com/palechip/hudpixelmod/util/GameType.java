...
public enum GameType {
    ...
    TNT_GAMES(5, 7, "TNT Games", "tnt", "THE TNT GAMES"),
    ...
    VAMPIREZ(10, 13, "VampireZ", "vampirez", "VAMPIREZ"),
    MEGA_WALLS(11, 13, "Mega Walls", "mega", "MEGA WALLS"),
    ARENA(12, 21, "Arena Brawl", "arena", "ARENA BRAWL"),
    ...
    ARCADE_GAMES(16, 17, "Arcade Games", "arcade", "ARCADE GAMES"),
