...
public class FancyChat {
    ...
    @ConfigPropertyBoolean(catagory = CCategory.FANCY_CHAT, id = "fancychat", comment = "The Fancy Chat", def = true)
    public static boolean enabled = true;

    //######################################################################################################################
    @ConfigPropertyInt(catagory = CCategory.FANCY_CHAT, id = "storedMessages", comment = "Stored Messages", def = 1000)
    public static int storedMessages;
    @ConfigPropertyInt(catagory = CCategory.FANCY_CHAT, id = "displayMessages", comment = "Displayed Messages", def = 8)
