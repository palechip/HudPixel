...
public class CooldownDisplayModule {
    ...
    public void renderModule(int xStart, int yStart) {
        ...
        if (Minecraft.getMinecraft().thePlayer.getHeldItem() != null
                && Minecraft.getMinecraft().thePlayer.getHeldItem().equals(Minecraft.getMinecraft().thePlayer.inventory.getStackInSlot(slot))) {
    ...
    public void onClientTick() {
        if (Minecraft.getMinecraft().thePlayer == null || Minecraft.getMinecraft().thePlayer.inventory == null
                || Minecraft.getMinecraft().thePlayer.inventory.getStackInSlot(slot) == null) {
            isHidden = true;
            return;
        }
        isHidden = false;
