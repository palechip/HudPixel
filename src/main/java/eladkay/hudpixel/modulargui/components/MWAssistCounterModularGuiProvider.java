...
public class MWAssistCounterModularGuiProvider extends SimpleHudPixelModularGuiProvider implements McColorHelper {
    ...
    @ConfigPropertyBoolean(category = CCategory.HUD, id = "megaWallsAssistCounter", comment = "The MW Assist Tracker", def = true)
    ...
    public String getAfterstats() {
        return YELLOW + "You got a total of " + GREEN + kills + YELLOW + " Assists.";
    }
